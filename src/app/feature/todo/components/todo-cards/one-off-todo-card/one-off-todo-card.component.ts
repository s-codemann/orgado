...
@Component({
  selector: 'app-one-off-todo-card',
  standalone: true,

  imports: [MatCardModule, DatePipe, MatButtonModule],
  templateUrl: './one-off-todo-card.component.html',
  styleUrl: './one-off-todo-card.component.scss',
})
export class OneOffTodoCardComponent {
